...
pub const v8_interprocedural = @import("v8_interprocedural.zig");
pub const v8_signature = @import("v8_signature.zig");
pub const v8_fixpoint = @import("v8_fixpoint.zig");
...
test {
    ...
    _ = @import("v8_interprocedural.zig");
    _ = @import("v8_signature.zig");
    _ = @import("v8_fixpoint.zig");
