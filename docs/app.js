...
{"struct":"RuntimeError","type":"struct","name":"RuntimeError","summary":"The default error type for ad-hoc, unstructured failures.","url":"structs/RuntimeError.html"},
{"struct":"ArgumentError","type":"struct","name":"ArgumentError","summary":"Raised when a function receives an argument that is the wrong shape,\nout of its accepted domain, or otherwise invalid in a way the type\nsystem did not catch.","url":"structs/ArgumentError.html"},
{"struct":"ArithmeticError","type":"struct","name":"ArithmeticError","summary":"Raised when integer arithmetic overflows its result type.","url":"structs/ArithmeticError.html"},
{"struct":"IndexError","type":"struct","name":"IndexError","summary":"Raised when a list or array is indexed outside its valid\n`0..length` range.","url":"structs/IndexError.html"},
{"struct":"Zap.ErrorCatalog","type":"struct","name":"Zap.ErrorCatalog","summary":"The Zap diagnostic-code catalog — the long-form source backing\n`zap explain Zxxxx`.","url":"structs/Zap.ErrorCatalog.html"},
...
{"struct":"Function","type":"struct","name":"Function","summary":"A first-class reference to a statically-known Zap function.","url":"structs/Function.html"},
...
{"struct":"List","type":"struct","name":"List","summary":"A flat-buffer sequence of elements.","url":"structs/List.html"},
...
{"struct":"Memory.ARC","type":"struct","name":"Memory.ARC","summary":"Atomic reference counting memory manager.","url":"structs/Memory.ARC.html"},
{"struct":"Memory.Arena","type":"struct","name":"Memory.Arena","summary":"Whole-program arena memory manager.","url":"structs/Memory.Arena.html"},
{"struct":"Memory.GC","type":"struct","name":"Memory.GC","summary":"Conservative tracing garbage-collected memory manager.","url":"structs/Memory.GC.html"},
{"struct":"Memory.Leak","type":"struct","name":"Memory.Leak","summary":"Diagnostic leak-everything memory manager.","url":"structs/Memory.Leak.html"},
{"struct":"Memory.NoOp","type":"struct","name":"Memory.NoOp","summary":"No-op memory manager.","url":"structs/Memory.NoOp.html"},
{"struct":"Memory.Tracking","type":"struct","name":"Memory.Tracking","summary":"Diagnostic tracking memory manager.","url":"structs/Memory.Tracking.html"},
{"struct":"Option","type":"struct","name":"Option","summary":"","url":"structs/Option.html"},
...
{"struct":"Result","type":"struct","name":"Result","summary":"","url":"structs/Result.html"},
{"struct":"Simd","type":"struct","name":"Simd","summary":"Tuple-backed SIMD operations.","url":"structs/Simd.html"},
...
{"struct":"Tuple","type":"struct","name":"Tuple","summary":"Heterogeneous fixed-arity product type.","url":"structs/Tuple.html"},
{"struct":"Type","type":"struct","name":"Type","summary":"A first-class reference to a Zap type.","url":"structs/Type.html"},
{"struct":"Zap.Build.Compile","type":"struct","name":"Zap.Build.Compile","summary":"Compile the current manifest artifact.","url":"structs/Zap.Build.Compile.html"},
{"struct":"Zap.Build.Pipeline","type":"struct","name":"Zap.Build.Pipeline","summary":"Build pipeline declaration used by `Zap.Manifest`.","url":"structs/Zap.Build.Pipeline.html"},
{"struct":"Zap.Build.Run","type":"struct","name":"Zap.Build.Run","summary":"Run the artifact produced by an earlier compile step.","url":"structs/Zap.Build.Run.html"},
{"struct":"Zap.Build.Step","type":"struct","name":"Zap.Build.Step","summary":"One step in a manifest build pipeline.","url":"structs/Zap.Build.Step.html"},
...
{"struct":"Zest.Assertion","type":"struct","name":"Zest.Assertion","summary":"Assertion result helpers for Zest.","url":"structs/Zest.Assertion.html"},
...
{"struct":"Callable","type":"protocol","name":"Callable","summary":"The `Callable` protocol — the existential interface every first-class\nclosure value implements.","url":"structs/Callable.html"},
...
{"struct":"Error","type":"protocol","name":"Error","summary":"The `Error` protocol — every value that can be raised or returned as an\nerror implements `Error`.","url":"structs/Error.html"},
...
{"struct":"Memory.Manager","type":"protocol","name":"Memory.Manager","summary":"Conformance marker for Zap memory managers.","url":"structs/Memory.Manager.html"},
...
{"struct":"Option","type":"union","name":"Option","summary":"","url":"structs/Option.html"},
{"struct":"Result","type":"union","name":"Result","summary":"","url":"structs/Result.html"},
...
{"struct":"Enum","type":"function","name":"last/2","summary":"","url":"structs/Enum.html#last-2"},
...
{"struct":"Enum","type":"function","name":"first/1","summary":"Returns the first element of the collection.","url":"structs/Enum.html#first-1"},
...
{"struct":"Enum","type":"function","name":"count/1","summary":"Returns the number of elements in the collection.","url":"structs/Enum.html#count-1"},
...
{"struct":"Enum","type":"function","name":"last/1","summary":"Returns the last element of the collection.","url":"structs/Enum.html#last-1"},
...
{"struct":"Enum","type":"function","name":"first/2","summary":"Returns the first element of the collection, or `default` when\nthe collection is empty.","url":"structs/Enum.html#first-2"},
...
{"struct":"Float","type":"function","name":"to_integer/1","summary":"Converts a float to an `i64` by truncating toward zero.","url":"structs/Float.html#to_integer-1"},
...
{"struct":"Float","type":"function","name":"to_string/2","summary":"Format a float to a fixed number of decimal places, matching\nC's `printf(\"%.<n>f\", value)` rounding semantics.","url":"structs/Float.html#to_string-2"},
...
{"struct":"Function","type":"function","name":"identity/1","summary":"Returns the value unchanged.","url":"structs/Function.html#identity-1"},
...
{"struct":"IO","type":"function","name":"write_byte/1","summary":"Writes a single raw byte to standard output through the buffered\nwriter.","url":"structs/IO.html#write_byte-1"},
...
{"struct":"Kernel","type":"function","name":"do_raise/1","summary":"Error-aware abort backing the surface `raise` keyword (Phase 1.4).","url":"structs/Kernel.html#do_raise-1"},
...
{"struct":"Kernel","type":"function","name":"raise_occurred/0","summary":"True when a `recoverable_raise` has fired in the current `try` body and\nhas not yet been consumed by a handler (Phase 3.a).","url":"structs/Kernel.html#raise_occurred-0"},
...
{"struct":"Kernel","type":"function","name":"peek_recoverable_raise/0","summary":"Read the pending recoverable-raise `Error` value WITHOUT clearing the\nside-channel or the captured error-return trace (Phase 4.a, ERT display).","url":"structs/Kernel.html#peek_recoverable_raise-0"},
{"struct":"Kernel","type":"function","name":"take_recoverable_raise/0","summary":"Read and clear the pending recoverable-raise `Error` value (Phase 3.a).","url":"structs/Kernel.html#take_recoverable_raise-0"},
...
{"struct":"Kernel","type":"function","name":"abort_recoverable_raise/0","summary":"Unhandled-`raise` terminus (Phase 3.b cross-function propagation).","url":"structs/Kernel.html#abort_recoverable_raise-0"},
{"struct":"Kernel","type":"function","name":"recoverable_raise/1","summary":"Recoverable raise sink backing a `raise` lexically inside a\n`try { … } rescue { … }` body (Phase 3.a).","url":"structs/Kernel.html#recoverable_raise-1"},
...
{"struct":"List","type":"function","name":"contains?/2","summary":"Returns `true` when `value` is present in the list.","url":"structs/List.html#contains?-2"},
{"struct":"List","type":"function","name":"set/3","summary":"Returns a list with `value` stored at `index`.","url":"structs/List.html#set-3"},
{"struct":"List","type":"function","name":"get/2","summary":"Returns the element at `index`.","url":"structs/List.html#get-2"},
{"struct":"List","type":"function","name":"at/2","summary":"Returns the element at `index`.","url":"structs/List.html#at-2"},
{"struct":"List","type":"function","name":"append/2","summary":"Concatenates two lists.","url":"structs/List.html#append-2"},
{"struct":"List","type":"function","name":"push/2","summary":"Returns a list with `value` added to the end.","url":"structs/List.html#push-2"},
{"struct":"List","type":"function","name":"take/2","summary":"Returns the first `count` elements.","url":"structs/List.html#take-2"},
{"struct":"List","type":"function","name":"filter/2","summary":"Keeps elements for which `predicate` returns true.","url":"structs/List.html#filter-2"},
{"struct":"List","type":"function","name":"head!/1","summary":"Returns the first element.","url":"structs/List.html#head!-1"},
{"struct":"List","type":"function","name":"last!/1","summary":"Returns the last element.","url":"structs/List.html#last!-1"},
{"struct":"List","type":"function","name":"at!/2","summary":"Returns the element at `index`.","url":"structs/List.html#at!-2"},
{"struct":"List","type":"function","name":"map/2","summary":"Transforms each element with `callback`.","url":"structs/List.html#map-2"},
{"struct":"List","type":"function","name":"pop/1","summary":"Removes the last element and returns `{list, value}`.","url":"structs/List.html#pop-1"},
{"struct":"List","type":"function","name":"prepend/2","summary":"Returns `value` followed by the contents of `list`.","url":"structs/List.html#prepend-2"},
...
{"struct":"List","type":"function","name":"capacity/1","summary":"Returns the list's reserved capacity.","url":"structs/List.html#capacity-1"},
{"struct":"List","type":"function","name":"uniq/1","summary":"Returns a list with duplicate values removed.","url":"structs/List.html#uniq-1"},
{"struct":"List","type":"function","name":"empty?/1","summary":"Returns `true` when the list has no elements.","url":"structs/List.html#empty?-1"},
{"struct":"List","type":"function","name":"last/1","summary":"Returns the last element, or the element type's default for an empty list.","url":"structs/List.html#last-1"},
{"struct":"List","type":"function","name":"head/1","summary":"Returns the first element, or the element type's default for an empty list.","url":"structs/List.html#head-1"},
{"struct":"List","type":"function","name":"tail/1","summary":"Returns all elements after the first as a new list.","url":"structs/List.html#tail-1"},
{"struct":"List","type":"function","name":"drop/2","summary":"Returns the list after dropping the first `count` elements.","url":"structs/List.html#drop-2"},
{"struct":"List","type":"function","name":"reverse/1","summary":"Returns a new list with elements in reverse order.","url":"structs/List.html#reverse-1"},
{"struct":"List","type":"function","name":"new_filled/2","summary":"Allocate a list of `size` elements, each initialized to `init`.","url":"structs/List.html#new_filled-2"},
{"struct":"List","type":"function","name":"new_empty/1","summary":"Allocate an empty list with at least `initial_capacity` reserved slots.","url":"structs/List.html#new_empty-1"},
{"struct":"List","type":"function","name":"reduce/3","summary":"Folds the list from left to right.","url":"structs/List.html#reduce-3"},
...
{"struct":"Option","type":"function","name":"and_then/2","summary":"Monadic flatMap: applies `f` to the payload of a `Some(...)`\nvalue, returning whichever `Option` the function produces.","url":"structs/Option.html#and_then-2"},
{"struct":"Option","type":"function","name":"unwrap_or/2","summary":"Returns the payload of a `Some(...)` value, or `default` when\n`opt` is `None`.","url":"structs/Option.html#unwrap_or-2"},
{"struct":"Option","type":"function","name":"map/2","summary":"Applies `f` to the payload of a `Some(...)` value, wrapping the\nresult back in `Some`.","url":"structs/Option.html#map-2"},
{"struct":"Option","type":"function","name":"is_none?/1","summary":"Returns `true` when `opt` is `None`, `false` when it carries a\n`Some(...)` value.","url":"structs/Option.html#is_none?-1"},
{"struct":"Option","type":"function","name":"is_some?/1","summary":"Returns `true` when `opt` is a `Some(...)` value, `false` when\nit is `None`.","url":"structs/Option.html#is_some?-1"},
...
{"struct":"Range","type":"function","name":"reverse/1","summary":"Flip a range's direction by swapping its `start` and `end` while\npreserving the step magnitude.","url":"structs/Range.html#reverse-1"},
{"struct":"Result","type":"function","name":"and_then/2","summary":"Monadic flatMap on `Ok(...)`: applies `f` to the success\npayload, returning whichever `Result` the function produces.","url":"structs/Result.html#and_then-2"},
{"struct":"Result","type":"function","name":"map_error/2","summary":"Applies `f` to the payload of an `Error(...)` value, wrapping\nthe result back in `Error`.","url":"structs/Result.html#map_error-2"},
{"struct":"Result","type":"function","name":"unwrap_or/2","summary":"Returns the payload of `Ok(...)`, or `default` when `r` is\n`Error(...)`.","url":"structs/Result.html#unwrap_or-2"},
{"struct":"Result","type":"function","name":"tuple_to_result/1","summary":"Migration shim (Phase 1.4): convert a legacy `{:ok, v}` / `{:error, e}`\ntuple into the canonical `Result` variants.","url":"structs/Result.html#tuple_to_result-1"},
{"struct":"Result","type":"function","name":"is_error?/1","summary":"Returns `true` when `r` is `Error(...)`, `false` when it is\n`Ok(...)`.","url":"structs/Result.html#is_error?-1"},
{"struct":"Result","type":"function","name":"is_ok?/1","summary":"Returns `true` when `r` is `Ok(...)`, `false` when it is\n`Error(...)`.","url":"structs/Result.html#is_ok?-1"},
{"struct":"Result","type":"function","name":"map/2","summary":"Applies `f` to the payload of an `Ok(...)` value, wrapping the\nresult back in `Ok`.","url":"structs/Result.html#map-2"},
{"struct":"Simd","type":"function","name":"select/3","summary":"Selects between two 2-lane tuples with a Bool mask tuple.","url":"structs/Simd.html#select-3"},
{"struct":"Simd","type":"function","name":"eq/2","summary":"Compares two 2-lane SIMD tuples for lane-wise equality.","url":"structs/Simd.html#eq-2"},
{"struct":"Simd","type":"function","name":"gte/2","summary":"Compares whether each lane in the left 2-lane tuple is greater than or equal to the right lane.","url":"structs/Simd.html#gte-2"},
{"struct":"Simd","type":"function","name":"mul/2","summary":"Multiplies two 2-lane SIMD tuples element-wise.","url":"structs/Simd.html#mul-2"},
{"struct":"Simd","type":"function","name":"ne/2","summary":"Compares two 2-lane SIMD tuples for lane-wise inequality.","url":"structs/Simd.html#ne-2"},
{"struct":"Simd","type":"function","name":"reduce_max/1","summary":"Returns the maximum lane in a 2-lane SIMD tuple.","url":"structs/Simd.html#reduce_max-1"},
{"struct":"Simd","type":"function","name":"lt/2","summary":"Compares whether each lane in the left 2-lane tuple is less than the right lane.","url":"structs/Simd.html#lt-2"},
{"struct":"Simd","type":"function","name":"reduce_min/1","summary":"Returns the minimum lane in a 2-lane SIMD tuple.","url":"structs/Simd.html#reduce_min-1"},
{"struct":"Simd","type":"function","name":"lte/2","summary":"Compares whether each lane in the left 2-lane tuple is less than or equal to the right lane.","url":"structs/Simd.html#lte-2"},
{"struct":"Simd","type":"function","name":"sub/2","summary":"Subtracts two 2-lane SIMD tuples element-wise.","url":"structs/Simd.html#sub-2"},
{"struct":"Simd","type":"function","name":"add/2","summary":"Adds two 2-lane SIMD tuples element-wise.","url":"structs/Simd.html#add-2"},
{"struct":"Simd","type":"function","name":"gt/2","summary":"Compares whether each lane in the left 2-lane tuple is greater than the right lane.","url":"structs/Simd.html#gt-2"},
{"struct":"Simd","type":"function","name":"reduce_add/1","summary":"Adds all lanes in a 2-lane SIMD tuple.","url":"structs/Simd.html#reduce_add-1"},
{"struct":"String","type":"function","name":"compare/2","summary":"Lexicographic byte-wise comparison of two strings.","url":"structs/String.html#compare-2"},
...
{"struct":"String","type":"function","name":"from_byte/1","summary":"Constructs a one-byte string from an integer in `0..255`.","url":"structs/String.html#from_byte-1"},
...
{"struct":"Zap.Doc","type":"function","name":"write_guide_pages/10","summary":"Render every entry in the guide manifest to\n`<out_dir>/guides/<slug>.html`.","url":"structs/Zap.Doc.html#write_guide_pages-10"},
{"struct":"Zap.Doc","type":"function","name":"downcase_index_walk/2","summary":"","url":"structs/Zap.Doc.html#downcase_index_walk-2"},
...
{"struct":"Zap.Doc","type":"function","name":"write_pages_to/15","summary":"Render every summary list to disk under `out_dir` and return the\ntotal number of pages written.","url":"structs/Zap.Doc.html#write_pages_to-15"},
{"struct":"Zap.Doc","type":"function","name":"downcase_byte/1","summary":"","url":"structs/Zap.Doc.html#downcase_byte-1"},
{"struct":"Zap.Doc","type":"function","name":"write_summary_pages/16","summary":"Iterate `summaries`, render each as a full HTML page, and write\n`<out_dir>/<name>.html`.","url":"structs/Zap.Doc.html#write_summary_pages-16"},
...
{"struct":"Zap.Doc","type":"function","name":"topbar_right_with_tabs/4","summary":"","url":"structs/Zap.Doc.html#topbar_right_with_tabs-4"},
{"struct":"Zap.Doc","type":"function","name":"guide_slug_from_source/1","summary":"Strip the directory prefix and `.md` suffix from a guide source\npath: `guides/integer.md` -> `integer`.","url":"structs/Zap.Doc.html#guide_slug_from_source-1"},
...
{"struct":"Zap.Doc","type":"function","name":"render_index_page/9","summary":"Compose the docs landing page.","url":"structs/Zap.Doc.html#render_index_page-9"},
{"struct":"Zap.Doc","type":"function","name":"sort_members_walk/2","summary":"","url":"structs/Zap.Doc.html#sort_members_walk-2"},
{"struct":"Zap.Doc","type":"function","name":"last_dotted_walk/3","summary":"","url":"structs/Zap.Doc.html#last_dotted_walk-3"},
{"struct":"Zap.Doc","type":"function","name":"downcase_ascii/1","summary":"","url":"structs/Zap.Doc.html#downcase_ascii-1"},
{"struct":"Zap.Doc","type":"function","name":"upcase_byte/1","summary":"","url":"structs/Zap.Doc.html#upcase_byte-1"},
...
{"struct":"Zap.Doc","type":"function","name":"guides_sidebar_group/3","summary":"Render the sidebar `Guides` group — pinned to the bottom of the\nsidebar.","url":"structs/Zap.Doc.html#guides_sidebar_group-3"},
...
{"struct":"Zap.Doc","type":"function","name":"title_case_walk/5","summary":"","url":"structs/Zap.Doc.html#title_case_walk-5"},
...
{"struct":"Zap.Doc","type":"function","name":"upcase_index/1","summary":"","url":"structs/Zap.Doc.html#upcase_index-1"},
...
{"struct":"Zap.Doc","type":"function","name":"sidebar/8","summary":"","url":"structs/Zap.Doc.html#sidebar-8"},
...
{"struct":"Zap.Doc","type":"function","name":"render_guide_sidebar_items/4","summary":"","url":"structs/Zap.Doc.html#render_guide_sidebar_items-4"},
...
{"struct":"Zap.Doc","type":"function","name":"slug_for_struct_name/1","summary":"Derive the guide slug for a struct by lowercasing the last\ndotted segment of its qualified name: `Integer` -> `integer`,\n`Zap.Doc.Builder` -> `builder`.","url":"structs/Zap.Doc.html#slug_for_struct_name-1"},
{"struct":"Zap.Doc","type":"function","name":"last_dotted_segment/1","summary":"","url":"structs/Zap.Doc.html#last_dotted_segment-1"},
...
{"struct":"Zap.Doc","type":"function","name":"collect_guide_slugs/2","summary":"Walk the guide manifest and pull each entry's slug out of the\n`:source_path` field.","url":"structs/Zap.Doc.html#collect_guide_slugs-2"},
{"struct":"Zap.Doc","type":"function","name":"struct_page_with_tabs/11","summary":"Compose a full struct/guide/index page with an optional\nReference/Guide topbar tab switch.","url":"structs/Zap.Doc.html#struct_page_with_tabs-11"},
{"struct":"Zap.Doc","type":"function","name":"render_topbar_tabs/3","summary":"Render the `<div class=\"topbar-tabs\">` Reference/Guide switch\nthat appears in the topbar's right cluster on pages where a\nstruct has a matching guide.","url":"structs/Zap.Doc.html#render_topbar_tabs-3"},
...
{"struct":"Zap.Doc","type":"function","name":"downcase_walk/4","summary":"","url":"structs/Zap.Doc.html#downcase_walk-4"},
{"struct":"Zap.Doc","type":"function","name":"downcase_index/1","summary":"","url":"structs/Zap.Doc.html#downcase_index-1"},
...
{"struct":"Zap.Doc","type":"function","name":"write_one_guide_page/11","summary":"","url":"structs/Zap.Doc.html#write_one_guide_page-11"},
...
{"struct":"Zap.Doc","type":"function","name":"render_summary_page/14","summary":"Compose a complete HTML page for a single module summary.","url":"structs/Zap.Doc.html#render_summary_page-14"},
...
{"struct":"Zap.Doc","type":"function","name":"struct_name_for_guide_slug/2","summary":"Find the qualified struct name whose lowercased last-segment\nmatches `slug`.","url":"structs/Zap.Doc.html#struct_name_for_guide_slug-2"},
...
{"struct":"Zap.Doc","type":"function","name":"render_guide_page/9","summary":"Compose the full HTML for one guide page.","url":"structs/Zap.Doc.html#render_guide_page-9"},
...
{"struct":"Zap.Doc","type":"function","name":"topbar_with_tabs/7","summary":"Render the topbar with an optional Reference/Guide tab switch in\nthe right cluster.","url":"structs/Zap.Doc.html#topbar_with_tabs-7"},
...
{"struct":"Zap.Doc","type":"function","name":"compose_topbar_tabs/3","summary":"","url":"structs/Zap.Doc.html#compose_topbar_tabs-3"},
...
{"struct":"Zap.Doc","type":"function","name":"title_case/1","summary":"Title-case a guide slug for sidebar display: `integer` → `Integer`,\n`getting_started` → `Getting Started`.","url":"structs/Zap.Doc.html#title_case-1"},
...
{"struct":"Zap.Doc","type":"function","name":"upcase_index_walk/2","summary":"","url":"structs/Zap.Doc.html#upcase_index_walk-2"},
{"struct":"Zap.Doc","type":"function","name":"function_detail/5","summary":"","url":"structs/Zap.Doc.html#function_detail-5"},
{"struct":"Zap.Doc","type":"function","name":"guide_sidebar_item/3","summary":"","url":"structs/Zap.Doc.html#guide_sidebar_item-3"},
...
{"struct":"Zest.Assertion","type":"function","name":"truthy_result/6","summary":"Records the result of a truthy assertion or rejection with a source location.","url":"structs/Zest.Assertion.html#truthy_result-6"},
{"struct":"Zest.Assertion","type":"function","name":"no_leaks_result/7","summary":"Records the result of an `assert_no_leaks { <block> }` assertion.","url":"structs/Zest.Assertion.html#no_leaks_result-7"},
{"struct":"Zest.Assertion","type":"function","name":"would_report_leak?/1","summary":"Pure decision: would an `assert_no_leaks` block with the given net live-\nallocation delta be reported as a leak? `true` for a positive delta (the\nblock left allocations live), `false` otherwise.","url":"structs/Zest.Assertion.html#would_report_leak?-1"},
{"struct":"Zest.Assertion","type":"function","name":"truthy_result/5","summary":"Records the result of a truthy assertion or rejection.","url":"structs/Zest.Assertion.html#truthy_result-5"},
{"struct":"Zest.Assertion","type":"function","name":"expect_leak_result/7","summary":"Records the result of an `@expect_leak`-inverted leak assertion.","url":"structs/Zest.Assertion.html#expect_leak_result-7"},
{"struct":"Zest.Assertion","type":"function","name":"comparison_result/10","summary":"Records the result of a comparison assertion or rejection with a source location.","url":"structs/Zest.Assertion.html#comparison_result-10"},
{"struct":"Zest.Assertion","type":"function","name":"comparison_result/9","summary":"Records the result of a comparison assertion or rejection.","url":"structs/Zest.Assertion.html#comparison_result-9"},
...
{"struct":"Zest.Runner","type":"function","name":"configure/0","summary":"Parses Zest runtime options from CLI arguments and applies them\nto the test tracker.","url":"structs/Zest.Runner.html#configure-0"},
{"struct":"Zest.Runner","type":"function","name":"parse_cli_args/2","summary":"Recursively scans CLI arguments for Zest runtime options and applies\neach to the test tracker.","url":"structs/Zest.Runner.html#parse_cli_args-2"},
...
{"struct":"Simd","type":"macro","name":"splat/3","summary":"Builds a homogeneous tuple by splatting one signed 8-bit lane value.","url":"structs/Simd.html#splat-3"},
{"struct":"Simd","type":"macro","name":"vector/3","summary":"Type-checks a homogeneous tuple as an SIMD lane tuple.","url":"structs/Simd.html#vector-3"},
{"struct":"Simd","type":"macro","name":"reduce/2","summary":"Reduces a lane tuple with `:add`, `:min`, or `:max`.","url":"structs/Simd.html#reduce-2"},
...
{"struct":"Tuple","type":"macro","name":"size/1","summary":"Returns the number of slots in a tuple.","url":"structs/Tuple.html#size-1"},
...
{"struct":"Zest.Case","type":"macro","name":"test/2","summary":"Defines a test group.","url":"structs/Zest.Case.html#test-2"},
{"struct":"Zest.Case","type":"macro","name":"case/3","summary":"Declares an executable case with setup context inside a `test` group.","url":"structs/Zest.Case.html#case-3"},
{"struct":"Zest.Case","type":"macro","name":"assert/1","summary":"Asserts that an expression evaluates to `true`.","url":"structs/Zest.Case.html#assert-1"},
{"struct":"Zest.Case","type":"macro","name":"setup/1","summary":"Declares setup code that runs before each case in a `test` group.","url":"structs/Zest.Case.html#setup-1"},
{"struct":"Zest.Case","type":"macro","name":"assert_no_leaks/1","summary":"Asserts that a block leaks no memory.","url":"structs/Zest.Case.html#assert_no_leaks-1"},
{"struct":"Zest.Case","type":"macro","name":"reject/2","summary":"Asserts that an expression evaluates to `false` with a custom message.","url":"structs/Zest.Case.html#reject-2"},
{"struct":"Zest.Case","type":"macro","name":"reject/1","summary":"Asserts that an expression evaluates to `false`.","url":"structs/Zest.Case.html#reject-1"},
{"struct":"Zest.Case","type":"macro","name":"case/2","summary":"Declares an executable case inside a `test` group.","url":"structs/Zest.Case.html#case-2"},
{"struct":"Zest.Case","type":"macro","name":"describe/2","summary":"Compatibility alias for the pre-migration Zest DSL.","url":"structs/Zest.Case.html#describe-2"},
{"struct":"Zest.Case","type":"macro","name":"assert/2","summary":"Asserts that an expression evaluates to `true` with a custom message.","url":"structs/Zest.Case.html#assert-2"},
{"struct":"Zest.Case","type":"macro","name":"teardown/1","summary":"Declares teardown code that runs after each case in a `test` group.","url":"structs/Zest.Case.html#teardown-1"},
